...
public class GradeAnalyzerTest { 
    ...
    @Test
    void calculateAverage_handlesListDifferentValues(){
        ArrayList<Integer> scores = new ArrayList<>(Arrays.asList(98, 95, 92)); 
        assertEquals(95.0, GradeAnalyzer.calculateAverage(scores));
    }
}